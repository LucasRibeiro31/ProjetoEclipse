...
public class inclusao_de_dados_cadastro_de_pld_sul {
	  ...
	  @Test
		public void login() throws InterruptedException {
			...
			driver.findElement(By.linkText("Cadastro de PLD")).click();
			 ...
			 driver.findElement(By.xpath("/html/body/bs-datepicker-container/div/div/div/div/bs-month-calendar-view/bs-calendar-layout/div[2]/table/tbody/tr[2]/td[3]")).click(); // mes 06
			
			    {
			      WebElement dropdown = driver.findElement(By.cssSelector(".form-group > .form-control"));
			      dropdown.findElement(By.xpath("/html/body/app-root/div/app-pld/div/div/div[1]/form/div/div[2]/div/select/option[2]")).click();
			    }
