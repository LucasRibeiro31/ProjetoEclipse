...
public class consultar_historico_envio {
...
static WebDriver driver; 
	...
	public void test() throws InterruptedException {
	    ...
	    driver.findElement(By.cssSelector(".col-2:nth-child(1) .form-control")).click();
	    ...
	    driver.findElement(By.xpath("/html/body/app-root/div[2]/app-envio-contratos/div/form/div/div[2]/div/input")).click();
	    driver.findElement(By.xpath("/html/body/bs-datepicker-container/div/div/div/div/bs-days-calendar-view/bs-calendar-layout/div[2]/table/tbody/tr[4]/td[5]/span")).click();
	    driver.findElement(By.cssSelector(".col-2 > .btn")).click();
