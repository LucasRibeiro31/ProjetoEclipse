...
public class inclusao_de_dados_cadastro_agente_ccee_comercializacao {
	...
	public static void setUpBeforeClass() throws Exception {
	  ...
	  @Test
		public void login() throws InterruptedException {
		    ...
		    driver.findElement(By.xpath("/html/body/app-root/div/app-agentes-ccee/div/div/div/form/div/div[1]/div/input")).sendKeys("A2");
		    driver.findElement(By.xpath("/html/body/app-root/div/app-agentes-ccee/div/div/div/form/div/div[2]/div/input")).sendKeys("Lucas E1");
		    driver.findElement(By.xpath("/html/body/app-root/div/app-agentes-ccee/div/div/div/form/div/div[3]/div/input")).sendKeys("01714436000105");
