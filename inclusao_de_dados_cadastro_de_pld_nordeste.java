...
public class inclusao_de_dados_cadastro_de_pld_nordeste {
	...
	public static void setUpBeforeClass() throws Exception {
	  ...
	  @Test
		public void login() throws InterruptedException {
			...
			driver.findElement(By.cssSelector("app-pld")).click();
			driver.findElement(By.cssSelector(".is-datepicker > .form-control")).sendKeys("03/21");
			driver.findElement(By.cssSelector(".form-group > .form-control")).click();
			
			    {
			      ...
			      dropdown.findElement(By.xpath("/html/body/app-root/div/app-pld/div/div/div[1]/form/div/div[2]/div/select/option[3]")).click();
			    }
