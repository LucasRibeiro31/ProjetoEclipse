...
public class inclusao_de_dados_cadastro_de_pld_norte {
	...
	public static void setUpBeforeClass() throws Exception {
	  ...
	  @Test
		public void login() throws InterruptedException {
			...
			driver.findElement(By.xpath("/html/body/bs-datepicker-container/div/div/div/div/bs-month-calendar-view/bs-calendar-layout/div[2]/table/tbody/tr[2]/td[1]")).click();
